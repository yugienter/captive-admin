...
export default function PaymentItem({ payment }) {
  ...
  const handleCheckPayment = (event) => {
    const listOrderCodes = payment.orders.map((order) => order.code);
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, row) => {
        return (
          <span className={"order-status order-" + text}>
            {orderStatus[text]}
          </span>
        );
      },
        ...
        <div className="row-content">
          <div className="left-content">
            <div className="payment-item-title w-full">
              <strong>Payment ID: #PO{payment.code}</strong>
            ...
            <div className="payment-item-subtitle">
              ...
              >
                <strong>
                  {
                    payment.orders.filter((x) => x.status === "submitted")
                      .length
                  }{" "}
                  orders{" "}
                </strong>
        ...
        {expanded && (
          <div className="row-table">
            <Table
              ...
              dataSource={payment.orders.filter(
