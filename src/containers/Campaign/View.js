...
import { BtnExcelIcon } from "../PaymentManage/Icon";
...
export default function View() {
	...
	const exportPayment = async () => {
		xlsx("admin/payments/export-csv").then((res) => {
			res.blob().then((b) => {
				console.log(b);
				FileSaver.saveAs(b, "campaign.xlsx", {
					...
					<TableWrapper
						...
						expandable={{
							expandedRowRender: (record) => (
								<ViewExpanded jobCode={record.code} />
							),
