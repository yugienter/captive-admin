            ...
            <div className="payment-detail__order__detail__job">
              <div className="payment-detail__order__detail__job__image">
                <Image
                  ...
                  src={mediaUrl(deal.company.avatar)}
                />
              </div>
              <div className="payment-detail__order__detail__job__info">
                <h4>{deal.company.name}</h4>
                <p>
              ...
              <table>
                <tbody>
                  <tr>
                    <td>
                      Order Money{" "}
                      <strong>({deal.totalOrderSubmitted} items)</strong>
                    </td>
                    <td>${formatMoney(deal.totalAmountSubmitted)}</td>
                  </tr>
                </tbody>
              </table>
              <div className="payment-detail__order__detail__total">
                <span>Total Payment</span>
                <span>${formatMoney(deal.totalAmountSubmitted)}</span>
              </div>
            </div>
          </div>
        </div>
...
export default CompanyPaymentRelease;
